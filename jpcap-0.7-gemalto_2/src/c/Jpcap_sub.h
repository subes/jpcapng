...
extern jmethodID printlnMID,handleMID,setPacketValueMID,setDatalinkPacketMID,setPacketDataMID,
  ...
  // !!!!!!!! updated by Manu Bachimon 1st December 2006 : able to specify IP and TCP option and checksum fields
...
extern unsigned short in_cksum2(void *ip,unsigned short *data,int size);
